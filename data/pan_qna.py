...
import pandas as pd
#디렉터리 불러오기
path = '폴더 위치/115.법률-규정 텍스트 분석 데이터_고도화_상황에 따른 판례 데이터/3.개방데이터/1.데이터/Training/02.라벨링데이터'
...
path = 'D:/ai 허브/115.법률-규정 텍스트 분석 데이터_고도화_상황에 따른 판례 데이터/3.개방데이터/1.데이터/Validation/02.라벨링데이터'
dir_list = os.listdir(path)
...
from tqdm import tqdm
#디렉터리 불러오기_other(qna)
path = 'D:/ai 허브/115.법률-규정 텍스트 분석 데이터_고도화_상황에 따른 판례 데이터/3.개방데이터/1.데이터/Other/Other'
dir_list = os.listdir(path)
